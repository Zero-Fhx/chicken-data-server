...
DashboardRouter.get('/projections', DashboardController.getProjections)
DashboardRouter.get('/comparisons', DashboardController.getComparisons)
DashboardRouter.get('/breakdown/sales', DashboardController.getSalesBreakdown)
DashboardRouter.get('/breakdown/purchases', DashboardController.getPurchasesBreakdown)
